...
\usepackage[top=37mm, bottom=37mm, outer=33mm, inner=33mm]{geometry}
...
% change color of text, example replace all \color{Black} with \color{lightgray}
...
\AddToShipoutPictureBG{\includegraphics[width=\paperwidth,height=\paperheight]{buddha-2.jpeg}}
